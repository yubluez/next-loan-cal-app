      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-slate-900">LoanSmart Calculator</span>
            </div>
          ...
          <div>
            ...
            <p className="mt-2 text-xs leading-relaxed text-slate-500">
              <span className="font-mono font-medium text-slate-700">M = P × [ r(1+r)ⁿ ] / [ (1+r)ⁿ - 1 ]</span>
              <br />
              โดยคำนวณอัตราดอกเบี้ยต่อเดือน <span className="font-mono text-slate-700">r = (อัตราต่อปี / 100) / 12</span>{" "}
              และจำนวนงวด <span className="font-mono text-slate-700">n</span> ในหน่วยเดือน
            </p>
          </div>
        ...
        <div className="mt-8 flex flex-col items-center justify-between border-t border-slate-100 pt-6 text-xs text-slate-400 sm:flex-row">
          ...
          <div className="mt-2 flex gap-4 sm:mt-0">
            ...
            <Link href="/loancal" className="hover:text-slate-600 transition-colors">
              หน้าคำนวณสินเชื่อ
            </Link>
          </div>
        </div>
